...
| <a name="input_network"></a> [network](#input\_network) | (Required) The VPC firewall the firewall belong to. Only firewalls that are in the distributed mode can have subfirewalls. | `string` | `""` | no |
